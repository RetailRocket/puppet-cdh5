...
#                       the name of a cdh5::hive::metastore::* class in
#                       hive/metastore/*.pp.
#
class cdh5::hive::master($metastore_database = 'postgresql') {
    class { 'cdh5::hive::server':    }
    class { 'cdh5::hive::metastore': }

    # Set up the metastore database by including
    # the $metastore_database_class.
    $metastore_database_class = "cdh5::hive::metastore::${metastore_database}"
    ...
    Class[$metastore_database_class] -> Class['cdh5::hive::metastore']
}
