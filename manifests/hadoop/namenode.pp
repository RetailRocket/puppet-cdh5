...
# cdh5::hadoop::nameservice_id), your JournalNodes should be running before
# this class is applied.
#
class cdh5::hadoop::namenode {
    Class['cdh5::hadoop'] -> Class['cdh5::hadoop::namenode']
    ...
    file { "${::cdh5::hadoop::config_directory}/hosts.exclude":
        ensure  => 'present',
        require => Package['hadoop-hdfs-namenode'],
    }

    # Ensure that the namenode directory has the correct permissions.
    file { $::cdh5::hadoop::dfs_name_dir:
        ensure  => 'directory',
        owner   => 'hdfs',
        group   => 'hdfs',
        mode    => '0700',
    ...
    exec { 'hadoop-namenode-format':
        ...
        creates => "${::cdh5::hadoop::dfs_name_dir_main}/current/VERSION",
        user    => 'hdfs',
        require => File[$::cdh5::hadoop::dfs_name_dir],
    }
    ...
    service { 'hadoop-hdfs-namenode':
        ...
        hasrestart => true,
        alias      => 'namenode',
        require    => [File["${::cdh5::hadoop::config_directory}/hosts.exclude"], Exec['hadoop-namenode-format']],
    }
}
