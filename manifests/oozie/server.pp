...
#
class cdh5::oozie::server(
    $database                               = $cdh5::oozie::defaults::database,

    $jdbc_database                          = $cdh5::oozie::defaults::jdbc_database,
    $jdbc_username                          = $cdh5::oozie::defaults::jdbc_username,
    $jdbc_password                          = $cdh5::oozie::defaults::jdbc_password,
    $jdbc_host                              = $cdh5::oozie::defaults::jdbc_host,
    $jdbc_port                              = $cdh5::oozie::defaults::jdbc_port,
    $jdbc_driver                            = $cdh5::oozie::defaults::jdbc_driver,
    $jdbc_protocol                          = $cdh5::oozie::defaults::jdbc_protocol,

    $smtp_host                              = $cdh5::oozie::defaults::smtp_host,
    $smtp_port                              = $cdh5::oozie::defaults::smtp_port,
    $smtp_from_email                        = $cdh5::oozie::defaults::smtp_from_email,
    $smtp_username                          = $cdh5::oozie::defaults::smtp_username,
    $smtp_password                          = $cdh5::oozie::defaults::smtp_password,

    $authorization_service_security_enabled = $cdh5::oozie::defaults::authorization_service_security_enabled,

    $oozie_site_template                    = $cdh5::oozie::defaults::oozie_site_template,
    $oozie_env_template                     = $cdh5::oozie::defaults::oozie_env_template
) inherits cdh5::oozie::defaults
{
    # cdh5::oozie::server requires hadoop client and configs are installed.
    Class['cdh5::hadoop'] -> Class['cdh5::oozie::server']
    # Also require cdh5::oozie client class.
    Class['cdh5::oozie']  -> Class['cdh5::oozie::server']
    ...
    $catalina_base = $cdh5::hadoop::use_yarn ? {
    ...
    cdh5::hadoop::directory { '/user/oozie':
        owner   => 'oozie',
        group   => 'hadoop',
        mode    => '0755',
        require => Package['oozie'],
    ...
    $oozie_sharelib_archive = $cdh5::hadoop::use_yarn ? {
...
/bin/rm -rf ${oozie_sharelib_tmpdir}",
        ...
        user    => 'oozie',
        require => Cdh5::Hadoop::Directory['/user/oozie'],
    }
    ...
    $database_class = "cdh5::oozie::database::${database}"
    if ($database) {
