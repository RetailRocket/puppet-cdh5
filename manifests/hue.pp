...
# This requires that cdh5::hadoop is included.
#
# If cdh5::hive and/or cdh5::oozie are included
...
#
# $oozie_url              - URL for Oozie API.  If cdh5::oozie is included,
...
#
class cdh5::hue(
    $http_host                = $cdh5::hue::defaults::http_host,
    $http_port                = $cdh5::hue::defaults::http_port,
    $secret_key               = $cdh5::hue::defaults::secret_key,

    $oozie_url                = $cdh5::hue::defaults::oozie_url,
    $oozie_security_enabled   = $cdh5::hue::defaults::oozie_security_enabled,

    $smtp_host                = $cdh5::hue::defaults::smtp_host,
    $smtp_port                = $cdh5::hue::defaults::smtp_port,
    $smtp_user                = $cdh5::hue::defaults::smtp_user,
    $smtp_password            = $cdh5::hue::defaults::smtp_password,
    $smtp_from_email          = $cdh5::hue::defaults::smtp_from_email,

    $httpfs_enabled           = $cdh5::hue::defaults::httpfs_enabled,

    $ssl_private_key          = $cdh5::hue::defaults::ssl_private_key,
    $ssl_certificate          = $cdh5::hue::defaults::ssl_certificate,

    $ldap_url                 = $cdh5::hue::defaults::ldap_url,
    $ldap_cert                = $cdh5::hue::defaults::ldap_cert,
    $ldap_nt_domain           = $cdh5::hue::defaults::ldap_nt_domain,
    $ldap_bind_dn             = $cdh5::hue::defaults::ldap_bind_dn,
    $ldap_base_dn             = $cdh5::hue::defaults::ldap_base_dn,
    $ldap_bind_password       = $cdh5::hue::defaults::ldap_bind_password,
    $ldap_username_pattern    = $cdh5::hue::defaults::ldap_username_pattern,
    $ldap_user_filter         = $cdh5::hue::defaults::ldap_user_filter,
    $ldap_user_name_attr      = $cdh5::hue::defaults::ldap_user_name_attr,
    $ldap_group_filter        = $cdh5::hue::defaults::ldap_group_filter,
    $ldap_group_name_attr     = $cdh5::hue::defaults::ldap_group_name_attr,
    $ldap_group_member_attr   = $cdh5::hue::defaults::ldap_group_member_attr,

    $hue_ini_template       = $cdh5::hue::defaults::hue_ini_template,
) inherits cdh5::hue::defaults
{
    Class['cdh5::hadoop'] -> Class['cdh5::hue']
    ...
    if (defined(Class['cdh5::hive'])) {
        ...
        # make sure cdh5::hive is applied before cdh5::hue.
        Class['cdh5::hive']  -> Class['cdh5::hue']
        ...
        file { '/etc/init.d/hue':
            source  => 'puppet:///modules/cdh5/hue/hue.init.d.sh',
            mode    => '0755',
            owner   => 'root',
            group   => 'root',
            require => Package['hue'],
    ...
    if ($ssl_private_key and $ssl_certificate) {
        ...
        if (($ssl_private_key == $cdh5::hue::defaults::ssl_private_key) and
            ($ssl_certificate == $cdh5::hue::defaults::ssl_certificate)) {
    ...
    $namenode_host = $::cdh5::hadoop::primary_namenode_host
